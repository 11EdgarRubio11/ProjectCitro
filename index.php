<?php include_once 'includes/templates/header.php'; ?>
        ...
        <section class="seccion contenedor">
            <h2>La mejor empresa de citricos de la huasteca</h2>
            <p>
            Como una empresa mexicana de jugos, somos un socio estratégico en la entrega de productos de frutas frescas y procesadas a nuestros clientes, ofreciendo soluciones confiables a través de una operación sostenible de la granja al mercado.
            </p>
        </section> <!--seccion-->
